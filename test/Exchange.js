...
describe('Exchange', () => {
	...
	describe('Withdrawing Tokens', () => {
		...
		describe('Failure', () => {
			it('fails for insufficient balances', async () => {
				// Attempt to withdraw tokens without depositing - HUWHAAAA?
	...
	describe('Order actions', async () => {
		...
		beforeEach(async () => {
			...
			// User 2 will APPROVE and then DEPOSIT tokens to the exchange
	...
	describe('Filling orders', async () =>{
		...
		describe('Success', () => {
			...
			it('Executes the trade and charges fees', async () =>{
				...
				// User 1 should have 0 Dapp tokens left after the order is FILLED
				// User 2 should have 1 Dapp tokens in their account
				// Fee Account should have ZERO because it is not accepting this token!
				...
				// User 1 should have 1 mDAI token after the order is FILLED
				// User 2 should have 0.9 mDAI tokens in their account
				// Fee Account should have 0.1 mDAI because that is the tokenGet, being FILLED
		...
		describe('Failure', () => {
			...
			it('rejects already filled orders', async () => {
				// Connect first and fill the order
				transaction = await exchange.connect(user2).fillOrder(1)
				await transaction.wait()

				// Try to fill it a second time, not possible
